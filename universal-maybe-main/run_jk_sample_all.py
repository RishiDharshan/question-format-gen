...
async def run():
    config_path = 'content_meta/jk_accounts_finance_sample_all_types.json'
    ...
    output_filename = f"jk_accounts_finance_sample_all_types_output_{int(asyncio.get_event_loop().time())}.docx"
